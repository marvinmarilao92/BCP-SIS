        ...
        [
            ...
            },
            {
                ...
                value: function init() {
                    ...
                    if (this.clickableElements.length) {
                        ...
                        var setupHiddenFileInput = function () {
                            ...
                            _this.hiddenFileInput.addEventListener(
                                "change",
                                function () {
                                    var _hiddenFileInput =
                                            _this11.hiddenFileInput,
                    ...
                    try {
                        ...
                        for (
                            var _iterator = this.events[Symbol.iterator](),
                                _step;
                            !(_iteratorNormalCompletion = (_step =
                                _iterator.next()).done);
                            _iteratorNormalCompletion = true
            ...
            },
            {
                ...
                value: function destroy() {
                    ...
                    return $a601ff30f483e917$export$2e2bcd8739ae039.instances.splice(
                        $a601ff30f483e917$export$2e2bcd8739ae039.instances.indexOf(
                            this
                        ),
                        1
                    );
            ...
            },
            {
                ...
                value: function getExistingFallback() {
                    var getFallback = function getFallback(elements) {
                        ...
                        try {
                            for (
                                var _iterator = elements[Symbol.iterator](),
                                    _step;
                                !(_iteratorNormalCompletion = (_step =
                                    _iterator.next()).done);
                                _iteratorNormalCompletion = true
                    ...
                    try {
                        for (
                            var _iterator = ["div", "form"][Symbol.iterator](),
                                _step;
                            !(_iteratorNormalCompletion = (_step =
                                _iterator.next()).done);
                            _iteratorNormalCompletion = true
            ...
            },
            {
                ...
                value: function removeFile(file) {
                    ...
                    this.files = $a601ff30f483e917$var$without(
                        this.files,
                        file
                    );
                        ...
                        function (dataUrl, canvas) {
                            if (canvas == null)
                                ...
                                if (
                                    ...
                                    resizedDataURL =
                                        $a601ff30f483e917$var$ExifRestore.restore(
                                            file.dataURL,
                                            resizedDataURL
                                        );
                                return callback(
            ...
            },
            {
                ...
                value: function cancelUpload(file) {
                    if (
                        ...
                        try {
                            for (
                                var _iterator = groupedFiles[Symbol.iterator](),
                                    _step;
                                !(_iteratorNormalCompletion = (_step =
                                    _iterator.next()).done);
                                _iteratorNormalCompletion = true
                    ...
                    this._transformFiles(files, function (transformedFiles) {
                        ...
                        if (files[0].upload.chunked) {
                            ...
                            var handleNextChunk = function () {
                                ...
                                startedChunkCount++;
                                var start =
                                    chunkIndex * _this1.options.chunkSize;
                                var end = Math.min(
                            ...
                            file.upload.finishedChunkUpload = function (
                                ...
                                chunk.responseHeaders =
                                    chunk.xhr.getAllResponseHeaders();
                    ...
                    if (!files[0].upload.chunked)
                        ...
                        for (var i = 0; i < file.upload.totalChunkCount; i++)
                            if (
                                ...
                                typeof file.upload.chunks[i].progress !==
                                    "undefined"
                            ) {
                                file.upload.progress +=
                ...
                value: function _errorProcessing(files, message, xhr) {
                    ...
                    try {
                        for (
                            ...
                            var file = _step.value;
                            file.status =
                                $a601ff30f483e917$export$2e2bcd8739ae039.ERROR;
        ...
        try {
            for (
                ...
                if (
                    ...
                    result.push(
                        new $a601ff30f483e917$export$2e2bcd8739ae039(dropzone)
                    );
                else result.push(undefined);
            }
        } catch (err) {
...
var $a601ff30f483e917$var$ExifRestore = // Based on MinifyJpeg
    ...
    /*#__PURE__*/ (function () {
        ...
        function $a601ff30f483e917$var$ExifRestore() {
            $6mU8w$swchelpers.classCallCheck(
                this,
                $a601ff30f483e917$var$ExifRestore
            );
        }
