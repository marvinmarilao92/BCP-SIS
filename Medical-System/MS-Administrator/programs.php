...
<section class="section2">
  <div class="card">
    <div class="p-2 mx-4 d-flex justify-content-center" style="border-bottom: solid 1px gray;">
      <h3 style ="color:#012970; padding-top: 2rem; margin-bottom: 2rem; margin-left: auto; margin-right: auto;">Program Logs</h3>
    </div>
    <div class="mx-4" style="border-bottom: solid 1px gray; display: flex; flex-direction: row-reverse;"> 
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">   
                      ...
                      <a  class="btn btn-danger" title="Close" href="resources/program_close.php?id=<?= $row['prog_id']?>"><i class="ri-close-line"></i></a>   
