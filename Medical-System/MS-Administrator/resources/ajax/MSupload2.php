...
echo '<div class="row ">
        <div class="col-lg-12 col-md-12 col-sm-12 text-center">
          <h5 class="mt-3">Recommendation Letter Template</h5><a href ="../assets/medhis/template.pdf" class="btn btn-primary" download><i class="bi bi-download"></i>&nbspDownload</a>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 text-center">
