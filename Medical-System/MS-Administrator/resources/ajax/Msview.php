<?php require_once 'Config.php';
 ...
 $pdate1 = $fetchLabtest['date_paid'];
 $pdate1 = $fetchLabtest['date_paid'];
 $pnewDate = date('F j, Y', strtotime($pdate1));
 $pnewTime = date('h:i:s', strtotime($pdate1));
?>
<div class="container">
  <div class="form-group">
    ...
    <div class="row pt-1">
      <div class="col">
        ...
        <input type="text" class="form-control" id="id_number" value="<?php echo $fetchLabtest['id_number']; ?>"
          disabled>
      </div>
      <div class="col">
    ...
    <div class="row pt-4">
      <h5 class="text-danger">Payment Date</h5>
      <div class="col">
        <small for="date">Date</small>
        <input type="text" class="form-control" id="date" value="<?php echo $pnewDate; ?>" disabled>
      </div>
      <div class="col">
        <small for="time">Time</small>
        <input type="text" class="form-control" id="time" value="<?php echo $pnewTime; ?>" disabled>
        <input type="hidden" id="file_name" value="<?php echo $fetchlabtest['file_name']; ?>" />
      </div>
    </div>
    <hr>
    <div class="row">
      <h5 class="text-danger">Date Validated</h5>
      <div class="col">
        <small for="date">Date</small>
