              ...
              <table class="table table-hover datatable" >
                ...
                <tbody>
                  <?php
                    ...
                    $query="SELECT * FROM datms_documents WHERE `doc_status` = 'Rejected' OR `doc_status` = 'Deleted'  AND (`doc_actor2`='$verified_session_firstname $verified_session_lastname ') ORDER BY doc_date2 DESC ";
