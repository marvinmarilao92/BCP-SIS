          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">Here Goes Medical Practitioner for Clinic Management</p>
              </div>
            </div>
          </div>
          <!-- End Insert your Module here -->
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">Here Goes Medical Nurse for Clinic Management</p>
              </div>
            </div>
          </div>
          <!-- End Insert your Module here -->
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">Here Goes Contact Tracing System for Clinic Management</p>
              </div>
            </div>
          </div>
        </div>
