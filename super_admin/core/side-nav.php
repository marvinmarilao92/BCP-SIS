  ...
  <li class="nav-item">
    ...
    <ul id="components-nav" class="<?php if($col=='logs'){echo 'nav-content collapse show';}else{echo 'nav-content collapse';}?> " data-bs-parent="#sidebar-nav">
     <li>
      ...
      <li>
        <a href="logs_approver.php?id=<?php echo $_SESSION["login_key"];?>" class="<?php if($page=='AL'){echo 'active';}?>">
          <i class="bi bi-circle"></i><span>Approver Logs</span>
        </a>
      </li>
      <li>
        <a href="logs_sec.php?id=<?php echo $_SESSION["login_key"];?>" class="<?php if($page=='SL'){echo 'active';}?>">
          <i class="bi bi-circle"></i><span>Assistan Logs</span>
        </a>
      </li>
      <li>
        <a href="logs_faculty.php?id=<?php echo $_SESSION["login_key"];?>" class="<?php if($page=='FL'){echo 'active';}?>">
