        ...
        <div class="container">
          <div class="card">
            <div class="row ">
              ...
              <div class="col">
                <div class="mb-2 d-flex flex-grow-* align-items-start justify-content-center flex-column m-2"
                  style="max-width: 764px;">
                  <h4>Drug name:</h4>
                  <input type="text" class="mb-1 form-control h5 border-2 rounded" value="<?php echo $med_name ?>"
                    disabled>
                  <h4>Scientific name:</h4>
                  <textarea type="text" row="2" class="mb-1 form-control h5 border-2 rounded"
                    value="<?php echo $scientific_name ?>" disabled><?php echo $scientific_name ?></textarea>
                  <h4>Manufactured:</h4>
                  <input type="text" class="mb-1 form-control h5 border-2 rounded" value="<?php echo $manufactured ?>"
                    disabled>
                  <h4>Expiry date:</h4>
                  <input type="text" class="mb-1 form-control h5 border-2 rounded" value="<?php echo $expiration ?>"
                    disabled>
                  <h4>Quantity:</h4>
                  <input type="text" class="mb-1 form-control h5 border-2 rounded" value="<?php echo $quantity ?>"
                    disabled>
                </div>
              </div>
            </div>
