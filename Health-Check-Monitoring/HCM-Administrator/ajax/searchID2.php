...
$resultforSEARCH = $db->query('SELECT * FROM hcms_checkup WHERE id_number = ?', $_GET['id_number'])->fetchArray();
...
<div class="card p-4">
  <div class="row p-2">
    ...
    <div class="col-md-6 col-sm-12 p-2">
      <input type="text" class="form-control text-primary" disabled name="BCPROLE" id="BCPROLE" value="Student"
        required>
    </div>
