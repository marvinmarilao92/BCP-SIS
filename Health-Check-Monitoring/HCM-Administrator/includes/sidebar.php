 ...
 <aside id="sidebar" class="sidebar">
   <ul class="sidebar-nav" id="sidebar-nav">
    ...
    ?>
     ...
     <li class="nav-item">
       <a href="services-health-check.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('health-services' == $page) {
        echo 'nav-link';
    } else {
        echo 'nav-link collapsed';
    }?>">
     ...
     <li class="nav-item">
       ...
       <ul id="incident-nav" class="d-flex flex-column <?php if ('incident-logs' == $nav) {
        echo 'nav-content collapse show';
    } else {
        echo 'nav-content collapse';
    }?> " data-bs-parent="#sidebar-nav">
         <li>
           <a href="minor-logs.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('minor' == $page) {
        echo 'active';
    }?>">
         ...
         <li>
           <a href="major-logs.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('major' == $page) {
        echo 'active';
    }?>">
         ...
         <li>
           <a href="add-incident-logs.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('log' == $page) {
        echo 'active';
    }?>">
     ...
     <li class="nav-item">
       ...
       <ul id="inventory-nav" class="<?php if ('inventory' == $nav) {
        echo 'nav-content collapse show';
    } else {
        echo 'nav-content collapse';
    }?> " data-bs-parent="#sidebar-nav">
        ...
        echo 'active';
         ...
         <li>
           <a href="medical-equipments.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('equipments' == $page) {
        echo 'active';
    }?>">
     ...
     <li class="nav-item">
       ...
       <ul id="records-nav" class="<?php if ('Records' == $nav) {
        echo 'nav-content collapse show';
    } else {
        echo 'nav-content collapse';
    }?> " data-bs-parent="#sidebar-nav">
         <li>
           <a href="records-add-student.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('Records-Add-Student' == $page) {
        echo 'active';
    }?>">
         ...
         <li>
           <a href="records-add-faculty.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('Records-Add-Faculty' == $page) {
        echo 'active';
    }?>">
     ...
     <li class="nav-item">
       ...
       <ul id="records-nav" class="<?php if ('records' == $nav) {
        ...
        echo 'nav-content collapse';
         ...
         <li>
           <a href="records-health.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('health' == $page) {
        echo 'active';
    }?>">
         ...
         <li>
           <a href="records-incident.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('incident' == $page) {
        echo 'active';
    }?>">
     ...
     <li class="nav-item">
       <a href="records-list.php?id=<?php echo $_SESSION['login_key']; ?>" class="<?php if ('Records-list' == $page) {
        echo 'nav-link';
    } else {
        echo 'nav-link collapsed';
    }?>">
