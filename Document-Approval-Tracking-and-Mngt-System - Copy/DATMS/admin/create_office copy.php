        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body" >           
              ...
              <button class="sql btn btn-primary">Export SQL</button>
              <button class="txt btn btn-primary">Export TXT</button>
              <button class="json btn btn-primary">Export JSON</button>
