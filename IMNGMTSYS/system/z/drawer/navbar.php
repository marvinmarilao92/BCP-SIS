...
<div class="d-flex align-items-center justify-content-between">
      <a href="z/.." class="logo d-flex align-items-center">
        <img src="../assets/img/BCPlogo.png" alt="">&nbsp;
        <span class="d-none d-lg-block" style="font-size: 1.2em;">Internship Administrator</span>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <?php if($dp == null){
                          echo'<img src="../assets/img/default.jpg" alt="Profile" class="rounded-circle">';
                            ...
                            echo'<img src="data:image;base64, '.base64_encode($dp).'" alt="Profile" class="rounded-circle">';
                          }

                          ?>
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $ad_fname; ?></span>
