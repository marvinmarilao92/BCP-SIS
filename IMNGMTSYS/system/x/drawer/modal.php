                      ...
                      ?>
                          ...
                          <div class="col-12">
                            <div class="form-floating">
                              <input type="text" class="form-control" name="skills" id="studnum"   placeholder="Student Number" required autofocus>
                          ...
                          <div class="col-12">
                            <div class="form-floating">
                            <input type="text" class="form-control" name="course" id="pyf"   placeholder="course" style="" required autofocus>
                          ...
                          <div class="col-12">
                            <div class="form-floating">
                            <textarea type="text" class="form-control" name="comments" id="pyfF"   placeholder="myf" style="height: 90px;" required autofocus></textarea>
