...
<div class="top-menu">
    <div class="container">
        <div class="row">
            ...
            <div id="fh5co-logo"><img src="../assets/img/logo300.png" width="30px" height="35px"><a href="index.php" style="color: rgb(29, 70, 146);"><i></i>Bestlink College of the Philippines</a></div>
            </div>
