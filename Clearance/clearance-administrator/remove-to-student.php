...
if(isset($_POST["name"]) && !empty($_POST["name"])){
    ...
    // Prepare an insert statement
        $sql = "DELETE FROM clearance_department_students WHERE department_name = ?";
...
<main id="main" class="main">
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Remove <?php echo trim($_GET["name"]); ?> to Student</h2>
