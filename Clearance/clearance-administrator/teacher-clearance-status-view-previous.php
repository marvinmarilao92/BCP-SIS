    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="teacher-clearance-previous.php?id=<?php echo $semester_id; ?>">teachers Clearance Status for <?php echo $current_sem; ?></a></li>
                      ...
                      if($result1 = mysqli_query($link, $sql1)){
                          if(mysqli_num_rows($result1) > 0){
                            ...
                            while($row1 = mysqli_fetch_array($result1)){
                              ...
                              $sql2 = "SELECT * FROM clearance_teacher_status_previous where clearance_requirement_id = '$temp_id' and teacher_id = '$temp_teacher_id' and semester_id = '$semester_id' Limit 1";
