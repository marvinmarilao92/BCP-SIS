          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php
                    ...
                    $sql = "SELECT * FROM clearance_teacher_semester";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                  if(mysqli_num_rows($result) != $count){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                        echo '<a href="teacher-clearance-previous.php?id='.$row['id'].'" target="" class="m-1 btn btn-primary" title="View Record" data-toggle="tooltip"><span class="bi bi-eye"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                  }
                                }
                    ...
                    ?>
              <div class="float-end">
                <a href="teacher-clearance.php"><button type="button" class="btn btn-primary">Back</button></a>
              </div>
            </div>
          </div>
        </div>
