    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="student-clearance.php">Students Clearance Status for <?php echo $current_sem; ?></a></li>
                      ...
                      if($result1 = mysqli_query($link, $sql1)){
                          if(mysqli_num_rows($result1) > 0){
                            ...
                            while($row1 = mysqli_fetch_array($result1)){
                              ...
                              $sql2 = "SELECT * FROM clearance_student_status where clearance_requirement_id = '$temp_id' and student_id = '$temp_student_id' Limit 1";
