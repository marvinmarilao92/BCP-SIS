  ...
  if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
      ...
      // Records created successfully. Redirect to landing page
                      header("location: student-clearance-status.php");
                      exit();
    }
  } else{
      echo "Oops! Something went wrong. Please try again later.";
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Reset Clearance of Students</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Reset Clearance of Students</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Reset Clearance of Students</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="reset" value="reset"/>
                            <p>Are you sure you want to Reset Clearance of Students?</p>
                            <p>
