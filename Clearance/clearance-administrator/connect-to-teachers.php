...
if(isset($_POST["name"]) && !empty($_POST["name"])){
    ...
    // Prepare an insert statement
        $sql = "INSERT INTO clearance_department_teachers (department_name) VALUES (?)";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                // Bind variables to the prepared statement as parameters
                $action = "Added " . trim($_POST["name"]) . " to teachers clearance";
...
<main id="main" class="main">
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Connect <?php echo trim($_GET["name"]); ?> to Teachers</h2>
