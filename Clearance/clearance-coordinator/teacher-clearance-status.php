...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Clearance Status of Teachers <?php echo $current_sem; ?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Clearance Status of Teachers <?php echo $current_sem; ?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                            ...
                            echo '<table id="example" class="table datatable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        $dept_id = 0;
                                        $sql2 = "SELECT * FROM clearance_department_teachers where department_name = '$verified_session_role'";
                                        ...
                                        $sql1 = "SELECT * FROM clearance_requirements_teachers where department = '$verified_session_role' and status = 'Active'";
                                        if($result1 = mysqli_query($link, $sql1)){
