        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                //Create user account
                    ...
                    // Notification
                    $notif = "Declined Clearance Requirement: \'" . trim($_POST["req_name"]) . "\' has been declined with remark: \'" . $param_remarks . "\'";
                    $date = date('Y-m-d H:i:s');
                    $link->query("INSERT INTO datms_notification (act1, stat1, act2, stat2, subject, notif, dept, status, date,affected) VALUES ('', '0', '$param_id', '0', 'Clearance Declined', '$notif', '$verified_session_role', 'Active', '$date', '123')") or die(mysqli_error($link)); 
