...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Clearance Status <?php echo $current_sem; ?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Clearance Status <?php echo $current_sem; ?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                            ...
                            echo '<table id="example" class="table datatable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        $teacher_id = $verified_session_username;
                                        $temp_dep_id = $row['id'];
                                        $requirements_completed = 0;
                                        $requirements_pending_initial = 0;
                                        $sql1 = "SELECT * FROM clearance_teacher_status where clearance_department_id = $temp_dep_id and teacher_id = '$teacher_id'";
                                        ...
                                        $sql1 = "SELECT * FROM clearance_requirements_teachers where department = '$temp_department' and status = 'Active'";
                                        if($result1 = mysqli_query($link, $sql1)){
