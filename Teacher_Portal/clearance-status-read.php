    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">List of <?php echo $str; ?>'s Clearance Requirements for Teachers</h5>
              <?php
                    $count = 0;
                    // Attempt select query execution
                    $department = trim($_GET["name"]);
                    $sql = "SELECT * FROM clearance_requirements_teachers where department = '$department'";
                            ...
                            echo '<table id="example" class="table datatable">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        $temp_id = $row['id'];
                                        $status = "";
                                        $sql1 = "SELECT * FROM clearance_teacher_status where clearance_requirement_id = '$temp_id' and teacher_id = '$verified_session_username' LIMIT 1";
