<?php 
 ...
 if(isset($_GET['view'])){
    ...
    // fetch file to download from database
        ...
        readfile('../../../../Healtch-Check-Monitoring/assets/uploads/' . $HCMSresult['file_name']);
        exit;
    }
      ...
      <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            <?php require_once 'Config.php';  $HCMSresult = $db->query('SELECT * FROM hcms_faculty_records WHERE stud_id = ?', $result['id_number'])->fetchArray();
