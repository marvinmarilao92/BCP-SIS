                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingOne">
                        ...
                        <a class="accordion-button" id="accordion1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"  aria-expanded="true" aria-controls="collapseOne" style="pointer-events: none;">
                          <div class="icon" >
                            <h6 id="text1" style="color: rgb(1, 55, 150); font-weight: bold;"><i class="" id="icon1"></i>Personal Information</h6>
                          </div>
                        </a>
                        <!-- End of button -->
                      </h2>
                          ...
                          <div class="accordion-body row g-3">
                            ...
                            <div class="col-md-12">
                              <div class="form-floating">
                                  <input type="text" class="form-control" name="first_name" id="first_name" onkeypress="return isTextKey(event)" placeholder="first name" Required>
                                  <label for="floatingName">First Name</label>
                                </div>
                              </div>
                              <div class="col-md-12">
                                <div class="form-floating">
                                  <input type="text" class="form-control" name="last_name" id="last_name" onkeypress="return isTextKey(event)" placeholder="last name" Required>
                                  <label for="floatingName">Last Name</label>
                                </div>
                              </div>
                              <div class="col-md-12">
                                <div class="form-floating">
                                  <input type="text" class="form-control" name="middle_name" id="middle_name" maxlength="1" onkeypress="return isTextKey(event)" placeholder="middle name" Required>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingTwo">
                        ...
                        <a class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="pointer-events: none;">
                          <div class="icon">
                            <h6 id="text2" style="color: rgb(1, 55, 150); font-weight: bold;"><i class="" id="icon2"></i>Address</h6>
                          </div>
                        </a>
                        <!-- End of button -->
                      </h2>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingThree">
                        ...
                        <a class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="pointer-events: none;"> 
                          <div class="icon">
                            <h6 id="text3" style="color: rgb(1, 55, 150); font-weight: bold;"><i class="" id="icon3"></i>Personal Information</h6>
                          </div>                   
                        </a>
                        <!-- End of button -->
                      </h2>
