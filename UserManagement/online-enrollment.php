...
<body>
  ...
  <main>
    ...
    <section class="section" style="margin-left: 20px; margin-right: 20px;">
      <div class="row">
        <!-- Admission Form -->
        <div class="col-lg-8">
          <form class="card" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
            onsubmit="return submitUserForm();" method="post">
            <div class="card-body">
              <h5 class="card-title">FILL OUT THE FOLLOWING
                <div class="progress mt-3" style="height: 30px;">
                  <div class="progress-bar progress-bar-striped bg-primary progress-bar-animated" id="progress"
              ...
              <div class="accordion" id="accordionExample" style="padding: 1px;">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingOne">
                    ...
                    <a class="accordion-button" id="accordion1" type="button" data-bs-toggle="collapse"
                      data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"
                      style="pointer-events: none;">
                      <div class="icon">
                        <h6 id="text1" style="color: rgb(1, 41, 112); font-weight: bold;"><i class=""
                            id="icon1"></i>Personal Information</h6>
                      </div>
                    </a>
                    <!-- End of button -->
                  </h2>
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body row g-3">
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          <input type="text" class="form-control" name="first_name" id="first_name"
                            onkeypress="return isTextKey(event)" placeholder="first name" Required
                            onchange="oncollapse()" autofocus>
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          <input type="text" class="form-control" name="last_name" id="last_name"
                            onkeypress="return isTextKey(event)" placeholder="last name" Required
                            onchange="oncollapse()">
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          <input type="text" class="form-control" name="middle_name" id="middle_name"
                            onkeypress="return isTextKey(event)" placeholder="middle name" onchange="oncollapse()">
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          <select class="form-select" name="religion" id="religion" aria-label="State"
                            onchange="oncollapse()">
                            <option value="" selected="selected" disabled="disabled">Select Religion</option>
                            <option value="African Traditional &amp; Diasporic">African Traditional &amp; Diasporic
                            </option>
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          <select class="form-select" name="civil_status" id="civil_status" aria-label="State" Required
                            onchange="oncollapse()">
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          <input type="Date" class="form-control" name="birthdate" id="birthdate"
                            onkeydown="return false" min="1988-12-31"
                            max="<?php $currentYear = date("Y");
                                                                                                                                                  $previousYear = $currentYear - 12;
                                                                                                                                                  echo $previousYear; ?>-12-31"
                            placeholder="birthday" Required onchange="oncollapse()">
                      ...
                      <div class="text-right">
                        <a class="btn btn-primary collapsed" type="button" id="next" onclick="nextFunction()"
                          data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"
                          style="margin-top: 10px;">NEXT</a>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingTwo">
                    ...
                    <a class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      ...
                      style="pointer-events: none;">
                      <div class="icon">
                        <h6 id="text2" style="color: rgb(1, 41, 112); font-weight: bold;"><i class=""
                            id="icon2"></i>Address</h6>
                      </div>
                    </a>
                    <!-- End of button -->
                  </h2>
                    ...
                    <div class="accordion-body">
                      <div class="col-12">
                        ...
                        <div class="row g-3">
                          <div class="col-md-12">
                            <div class="form-floating">
                              <input type="text" class="form-control" name="add_st1" id="add_st1"
                                placeholder="Your Name" required onchange="oncollapse1()">
                              <label for="floatingName">Street Address</label>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-floating">
                              <input type="text" class="form-control" name="add_st2" id="add_st2"
                                placeholder="Your Name" onchange="oncollapse1()">
                          ...
                          <div class="text-right">
                            <a type="reset" class="btn btn-primary collapsed" id="next2" onclick="next2Function()"
                              data-bs-target="#collapseThree" aria-expanded="false"
                              aria-controls="collapseThree">NEXT</a>
                            <a class="btn btn-light collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                              aria-expanded="true" aria-controls="collapseOne" onclick="prev()">PREVIOUS</a>
                            <a class="btn btn-light rounded-pill" href="https://zip-codes.philsite.net/"
                              style="float: right; color:blue;" target="_blank">List of Zip Code</a>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                      ...
                      <a class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        style="pointer-events: none;">
                        <div class="icon">
                          <h6 id="text3" style="color: rgb(1, 41, 112); font-weight: bold;"><i class=""
                              id="icon3"></i>Contact Information</h6>
                        </div>
                      </a>
                      <!-- End of button -->
                    </h2>
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                      ...
                      <div class="accordion-body row g-3">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                          ...
                          Please input your active contact number and email address. BCP will use these means to
                          communicate the status of your application.
                          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="col-md-12">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="contact" id="contact" placeholder="number"
                              onChange="oncollapse2()" onkeypress="return isNumberKey(event)" maxlength="11"
                        ...
                        <div class="col-md-12">
                          <div class="form-floating">
                            <input type="email" class="form-control" name="email" id="email" placeholder="Email"
                              onChange="oncollapse2()" required>
                            <label for="floatingName" required>Email Address</label>
                          </div>
                        </div>
                        <div class="g-recaptcha" data-sitekey="6LeGr6kfAAAAAPgPSzckwkJ78QLrILqvo9IIyjzU"
                        ...
                        <div class="text-right">
                          ...
                          <a class="btn btn-light collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                            aria-expanded="false" aria-controls="collapseTwo" onclick="prev1()">PREVIOUS</a>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            <div class="card-header">
              <h3 style="margin-top: 10px; color:rgb(1, 55, 150);">
                <solid>Requirements</solid>
                <h5 style="color: rgb(1, 55, 150);">Admission Requirements for College</h5>
              </h3>
            </div>
  ...
  function oncollapse() {
    ...
    if (fname == "" || lname == "" || agender == "" || abirthdate == "" || anationality == "" || acivil_status == "" ||
      acourse == "") {
