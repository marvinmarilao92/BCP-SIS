                            ...
                            <div class="accordion-body row g-3">
                              ...
                              <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="first_name" id="first_name" style="text-transform:capitalize;" onkeypress="return isTextKey(event)" placeholder="first name" Required>
                                    <label for="floatingName">First Name</label>
                                  </div>
                                </div>
                                <div class="col-md-12">
                                  <div class="form-floating">
                                    <input type="text" class="form-control" name="last_name" id="last_name" style="text-transform:capitalize;" onkeypress="return isTextKey(event)" placeholder="last name" Required>
                                    <label for="floatingName">Last Name</label>
                                  </div>
                                </div>
                                <div class="col-md-12">
                                  <div class="form-floating">
                                    <input type="text" class="form-control" name="middle_name" id="middle_name" maxlength="1" style="text-transform:uppercase" onkeypress="return isTextKey(event)" placeholder="middle name" Required>
                                ...
                                <div class="col-md-12">
                                  <div class="form-floating">
                                    <select class="form-select" name="civil_status" id="civil_status" aria-label="State" onchange="nextFunction()">
                          ...
                          <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                            ...
                            <!-- Multi Columns Address Form -->
                              <div class="row g-3">
                                <div class="col-md-12">
                                  <div class="form-floating">
                                    <input type="text" class="form-control" name="add_st1" id="add_st1" style="text-transform:capitalize;"  placeholder="Your Name">
                                    <label for="floatingName">Street Address</label>
                                  </div>
                                </div>
                                <div class="col-md-12">
                                  <div class="form-floating">
                                    <input type="text" class="form-control" name="add_st2" id="add_st2" style="text-transform:capitalize;"  placeholder="Your Name">
                                    <label for="floatingName">Street Address Line 2 (Optional)</label>
                                  </div>
                                </div>
                                <div class="col-md-8">
                                  <div class="form-floating">
                                    <input type="text" class="form-control" name="city" id="city" style="text-transform:capitalize;"  placeholder="Your Name">
                                    <label for="floatingName">City</label>
                                  </div>
                                </div>
                                <div class="col-md-4">
                                  <div class="form-floating">
                                    <input type="text" class="form-control" name="zip_code" id="zip_code"  placeholder="Your Name" onchange="next2Function()">
  ...
  <script>
    ...
    function nextFunction() {
      ...
      if(fname =="" || lname =="" || agender =="" || abirthdate =="" || anationality =="" || areligion =="" || acivil_status =="" || acourse ==""){
        ...
        document.getElementById("icon1").setAttribute("class","bi bi-exclamation-triangle-fill me-1");
    ...
    function next2Function() {
      ...
      if(add1 =="" || add2 =="" || act =="" || azp =="" ){
        Swal.fire("You must fill out every field","","warning");
        document.getElementById("icon2").setAttribute("class","bi bi-exclamation-triangle-fill me-1");
    ...
    function next3Function() {
      ...
      if(acpno =="" || acpno =="" ){
        Swal.fire("You must fill out every field","","warning");
        document.getElementById("icon3").setAttribute("class","bi bi-exclamation-triangle-fill me-1");
