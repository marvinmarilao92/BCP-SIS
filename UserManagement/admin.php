...
<body>
  ...
  <?php $page = 'EI';
  include('includes/sidebar.php'); //Design for sidebar
  ?>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="col-lg-12">
              ...
              <div class="form-group col-md-1.5 btn-lg" data-bs-toggle="modal" data-bs-target="#AddModal"
                style="float: right; padding:20px;">
                <a href="admin-create.php?id=<?php echo $_SESSION["login_key"]; ?>"
                  class="btn btn-primary pull-right">Add New User</a>
              </div>
            </div>
            <div class="card-body">
              <?php
