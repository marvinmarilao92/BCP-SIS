<?php
      ...
      session_start();
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          //Check if the student is already in the database the database
          $sql5 = "SELECT id FROM student_application WHERE firstname = '$first_name' AND lastname = '$last_name' AND middlename = '$middle_name'";
