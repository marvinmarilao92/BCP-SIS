    ...
    background-size: cover; background-attachment: fixed;">
        ...
        <main id="main" class="main">
            ...
            <div class="form-row" >
              <div class="form-group col-sm-2" ></div>
                <div class="form-group col-sm-8" >
                    <label for="JPosting" >Title:</label>
            ...
            <div class="form-row" >
              <div class="form-group col-sm-2" ></div>
                <div class="form-group col-sm-8" >
                    <label for="JPosting" >Start at:</label>
            ...
            <div class="form-row" >
              <div class="form-group col-sm-2" ></div>
                <div class="form-group col-sm-8" >
                    <label for="JPosting" >End at:</label>
            ...
            <div class="form-row" >
              <div class="form-group col-sm-2" ></div>
                <div class="form-group col-sm-8" >
                    <label for="JPosting" >Video:</label>
            ...
            <div class="form-row" >
              <div class="form-group col-sm-2" ></div>
                <div class="form-group col-sm-8" >
                    <label for="JPosting" >Description:</label>
