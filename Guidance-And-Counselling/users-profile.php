                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">
                      <?php echo $verified_session_firstname . " " . $verified_session_lastname ?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="profile_update.php" method="POST">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about"
                          style="height: 100px"><?php echo $verified_session_about ?>.</textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="office" type="text" class="form-control" id="company"
                          value="<?php echo $verified_session_office ?>" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="dept" type="text" class="form-control" id="dept"
                          value="<?php echo $verified_session_department ?>" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="role" type="text" class="form-control" id="role"
                          value="<?php echo $verified_session_role ?>" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="address" type="text" class="form-control" id="address"
                          value="<?php echo $verified_session_address ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="phone" type="text" class="form-control" id="phone"
                          value="<?php echo $verified_session_contact ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="email"
                          value="<?php echo $verified_session_email ?>">
                      </div>
                    </div>

                    <div class="text-center">
                      <button class="btn btn-danger" name="submit" type="submit" id="updateProfile">Save
                        Changes</button>
