...
$saveJob_Title        =   $_POST["saveJob_Title"];
$saveJob_Type         =   $_POST["saveJob_Type"];
$saveJob_Description  =   $_POST["saveJob_Description"];
$saveSalary           =   $_POST["saveSalary"];
$saveWork_Location    =   $_POST["saveWork_Location"];
$savejob_link         =   $_POST["savejob_link"];

$updatePost = $db->query('UPDATE gac_jobpost SET
job_link=?, Job_Title=?, Job_Type=?, Work_Location=?,
Salary=?, Job_Description=?, updated_at=? WHERE ID=?',

$savejob_link, $saveJob_Title, $saveJob_Type, $saveWork_Location, $saveSalary, $saveJob_Description,
...
<div class="form-group col-sm-2" ></div>
  <div class="form-group col-sm-8" >
    <div class="alert alert-success alert-dismissible fade show" role="alert">
      <strong>Great!</strong> Details has been updated!.
