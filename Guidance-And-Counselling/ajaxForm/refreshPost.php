...
foreach ($jobPost as $post) { ?>
  <div class="form-row animate__animated animate__fadeInUp" style="margin-bottom: 20px; ">
          ...
          <span class="float-right" style="" >
            <div class="dropdown show ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="#"><i class="bi bi-image" onclick="setKeyPhoto(<?php echo $post["ID"]; ?>);"></i> Change Photo</a>
