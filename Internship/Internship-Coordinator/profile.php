...
<body >
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="Internship-Administrator/..">Home</a></li>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <?php if($_SESSION['myavatar'] == null){
                          ...
                          ?>
              <h2><?php echo $verified_session_firstname;?> <?php echo $verified_session_lastname?></h2>
              <h3><?php echo $verified_session_role?></h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $verified_session_firstname ?> <?php echo $verified_session_lastname ?></div>
                  </div>
