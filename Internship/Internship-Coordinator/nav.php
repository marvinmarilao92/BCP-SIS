      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <?php if($_SESSION['myavatar'] == null){
                          ...
                          ?>
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $verified_session_firstname;  ?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h5><b><?php echo $verified_session_firstname;?> <?php echo $verified_session_lastname?></b></h5>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="profile.php?id=<?php echo $_SESSION["login_key"]; ?>">
