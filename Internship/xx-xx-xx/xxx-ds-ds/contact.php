...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/me_img.jpg" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo($_SESSION['ad_user']);?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
               <h6><?php echo($_SESSION['ad_user']);?></h6>
              <span>Staff</span>
            </li>
            <li>
              <hr class="dropdown-divider">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="login-admin.php?t_#id=202390219342">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="user_profile.php?t=#id=@928392173100323#">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
  ...
  <main id="main" class="main">
    ...
    <section class="section contact">
        ...
        <div class="col-xl-12">
          <div class="card p-5">
            <form action="include/sender.php" method="POST" class="php-email-form">
              <div class="row gy-4">

                <div class="col-md-6">
                  <input type="text" name="fromEmail" id="fromEmail" class="form-control" placeholder="From: " value ="BCP@InternOnline.com" readonly required autofocus>
                </div>

                <div class="col-md-6 ">
                  <input type="email" class="form-control" id="ToEmail" name="toEmail" placeholder="To: " required>
                </div>
