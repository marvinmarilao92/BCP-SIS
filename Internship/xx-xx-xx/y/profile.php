          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                <?php if($_SESSION['myavatar'] == null){
                          ...
                          ?>
              <h2><?php echo($_SESSION['myfname']);?> <?php echo($_SESSION['mylname']);?></h2>
              <h3 style="font-size: 12px";><?php echo($_SESSION['mytitle']);?></h3>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic"><?php echo($_SESSION['myabout']);?></p>

                  <h5 class="card-title">Company Details</h5>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Company Name</div>
                    <div class="col-lg-9 col-md-8"><?php echo($_SESSION['myfname']);?> <?php echo($_SESSION['mymname']);?> <?php echo($_SESSION['mylname']);?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Type</div>
                    <div class="col-lg-9 col-md-8"><?php echo($_SESSION['mytitle']);?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo($_SESSION['myemail']);?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    ?>
                          ...
                          <!--<a href="#" class="btn btn-primary btn-sm" title="Upload new profile image"><input accept="image/*" type="file" name="image"  required ><i class="bi bi-upload" type="file"
                          accept="image/*"></i></a>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="<?php echo($_SESSION['myfname']);?> <?php echo($_SESSION['myfname']);?> <?php echo($_SESSION['mylname']);?>">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="about" class="col-md-4 col-lg-3 col-form-label">Established In</label>
                      <div class="col-md-8 col-lg-9">
                        <input type = "date" name="about" class="form-control" id="about" style="height: 100px"><?php echo($_SESSION['myabout']);?>
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Type</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                     <label for="company" class="col-md-4 col-lg-3 col-form-label">People</label>
                     <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="country" type="text" class="form-control" id="Country" value="<?php echo($_SESSION['mycountry']);?>">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Address" class="col-md-4 col-lg-3 col-form-label">City / Town</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="address" type="text" class="form-control" id="Address" value="<?php echo($_SESSION['mystreet']);?> <?php echo($_SESSION['mycity']);?>, <?php echo($_SESSION['myzip']);?>">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Phone" class="col-md-4 col-lg-3 col-form-label">Street</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="phone" type="text" class="form-control" id="Phone" value="<?php echo($_SESSION['myphone']);?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="<?php echo($_SESSION['myemail']);?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <div class="col-md-8 col-lg-9">
                            <select name="people" required class="selectpicker show-tick form-control mb-15" data-live-search="false">
                              <option  value="1-10">PHILIPPINES</option>
                              <option  value="11-100">USA</option>
                              <option  value="200+" >CALIFORNIA</option>
                              <option  value="300+">LEBANON</option>
                              <option  value="1000+">MEXICO</option>
                            </select>
                          </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Facebook" class="col-md-4 col-lg-3 col-form-label">Phone Number</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="Instagram" class="col-md-4 col-lg-3 col-form-label">Email Address</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="Linkedin" class="col-md-4 col-lg-3 col-form-label">Company Background</label>
                      <div class="col-md-8 col-lg-9">
                     ...
                     <div class="row mb-3">
                      <label for="Linkedin" class="col-md-4 col-lg-3 col-form-label">Services</label>
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" style="height: 100px">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</textarea>    
                      </div>
                    </div>
                     ...
                     <div class="row mb-3">
                      <label for="Linkedin" class="col-md-4 col-lg-3 col-form-label">Expertise</label>
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" style="height: 100px">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</textarea>    
                      </div>
                    </div>
