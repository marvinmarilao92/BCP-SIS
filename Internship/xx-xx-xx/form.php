...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="form.php?=<?php echo($_SESSION['id']);?>">
          <i class="bi bi-person"></i>
          <span>OJT</span>
        </a>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="login.php?=<?php echo($_SESSION['id']);?>">Home</a></li>
          <li class="breadcrumb-item active">OJT / Fill up</li>
        </ol>
      </nav>
    ...
    <section class="section dashboard">
      <div class="container">
            ...
            <div class="card-body">
              ...
              <!-- Donut Chart -->
              <div class="pagetitle">
                  <aria-label class="display-5" style="font-size: 2rem";>Bestlink College of the Philippines
                  </aria-label>
              </div><!-- End Page Title -->
    <hr class="my-4">
    <div class="no-overflow">
      <h3 style="background: rgba(116, 185, 255,0.2); padding: 5px 10px; color: rgba(9, 132, 227,1.0)">Fill Up</h3><br>
