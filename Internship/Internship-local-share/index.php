...
<head>
  ...
  <title>Bestlink College of the Philippines - Internship</title>
  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Your Bright<br><span>Future</span><br>starts
                    here now.</h2>
        <div>
          <a href="docx.php" class="btn-get-started scrollto">Register Now !</a>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/app12.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="portfolio-details.html">App 1</a></h4>
                <p>App</p>
                <div>
                  <a href="assets/img/portfolio/app12.jpg" data-gallery="portfolioGallery" title="App 1" class="portfolio-lightbox link-preview"><i class="bi bi-plus"></i></a>
    ...
    <section id="team">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h3>SCHOOL OFFICIAL & PROFESSORS</h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="map mb-4 mb-lg-0">
              <iframe src="https://maps.google.com/maps?q=Bestlink%20College%20of%20the%20Philipines&t=k&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="border:0; width: 100%; height: 340px;" allowfullscreen></iframe>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-5 info">
                ...
                <p>#1071 Brgy. Kaligayahan, Quirino Highway
                            Novaliches Quezon City, Philippines 1123</p>
              </div>
