...
<head>
  <title>Bestlink College Of the Philippines - Sign Up</title>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs" >
      <div class="container">
        ...
        <p><b>Note:</b> Please provide your personal details to create account.</p>
        ...
        <div class = "row g-0" >
          <div class="card-body p-md-5 mx-md-5">
            <?php if (isset($_GET['error'])) { ?>
                 ...
                 <?php } ?>
          <form class = "needs-validation" action="constant/reg.php" method="POST">


          <div class="form-floating mb-3">
              <input type="email" name="email" class="form-control" id="floatingInput" placeholder = "x">
              <label for="floatingInput">Email Address</label>
          </div>
          <div class="form-floating mb-3">
              <input type="password" name="password" class="form-control" id="floatingPassword" placeholder= "x" maxlength="8" >
              <label for="floatingPassword">Password</label>
          </div>
          <div class="form-floating mb-3">
              <input type="password" name="repass" class="form-control" id="floatingPassword" placeholder= "x" maxlength="8" >
              <label for="floatingPassword">re-Type Password</label>
          </div>
          <div class="form-floating mb-3">
              <div class="form-check">
                        <input class="form-check-input" name="terms" type="checkbox" value="" id="acceptTerms" required>
                        <label class="form-check-label" for="acceptTerms">I agree and accept the <a href="" data-bs-toggle="modal" data-bs-target="#largeModal">
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1><i class="bi bi-exclamation-circle"></i>
                      <label class="modal-title">Terms and Conditions</label>
                      
                    </div>
                     <div class="modal-body" style="text-align: justify; text-justify: inter-word;  overflow-y: scroll; height:750px; width:795px;">
                    ...
                    <div class="modal-footer">
                      ...
                      <a type="button" class="btn btn-primary" data-bs-dismiss="modal">I Agree</a>
                    </div>
                  </div>
                </div>
              </div>
