                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title">Magandang Buhay !</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body" style="text-align: justify; text-justify: inter-word; overflow-y: scroll;  height:420px; ">
                    
                    <form class="row g-3 needs-validation" action="auth/ges.php" method="POST">
                   
                    <h4 class="custom">Please Sign Up!</h4><br>
                    <hr>
                          <div class="col-12">
                            <div class="form-floating">
                              <input type="text" class="form-control" name="companyname"  placeholder="Student Name" required autofocus>
                          ...
                          <div class="col-12">
                            <div class="form-floating">
                              <input type="email" class="form-control" name="emailad"  placeholder="Student Number" required autofocus>
                          ...
                          <div class="col-12">
                            <div class="form-floating">
                            <input type="password" class="form-control" name="password"  placeholder="Payment For"  required autofocus>
                          ...
                          <div class="col-12">
                            <div class="form-floating">
                              <input type="password" class="form-control" name="re_pass" pattern="[a-zA-Z0-9]+" placeholder="Amount" required autofocus>
                          ...
                          <div class="container">
                                ...
                                <small id="passwordHelpBlock" class="form-text text-muted">
                                    Your file must be contain , Images, take a pic of your Company ID front & back , take a pic while holding your Company ID and save as docx.
                                </small>
                            </center>
                          </div>
                          </div>
