                  ...
                  <form class="row g-3 needs-validation" action="auth/check.php" method="POST" >
                    ...
                    <div class="col-12">
                      <div class="form-floating">
                        <input type="text" class="form-control" name="uname" id="username"  pattern="[a-zA-Z0-9]+" placeholder="Username" autofocus>
                    ...
                    <div class="col-12">
                      <div class="form-floating">
                        <input type="password" class="form-control" name="password" id="password"  pattern="[a-zA-Z0-9]+" placeholder="*********" autofocus>
