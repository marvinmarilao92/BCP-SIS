...
if(isset($_POST["view"]))
{
 ...
 if($_POST["view"] != '')
 {
  $update_query = "UPDATE datms_notification SET stat1 = 1 WHERE (act1 = '$verified_session_role' OR act1 = 'Registrar') AND stat1 = 0";
  mysqli_query($conn, $update_query);
 }
 $query = "SELECT * FROM datms_notification WHERE (act1 = '$verified_session_role' OR act1 = 'Registrar') ORDER BY date desc LIMIT 10";
 ...
 $query_1 = "SELECT * FROM datms_notification WHERE (act1 = '$verified_session_role ' OR act1 = 'Registrar') AND stat1 = 0";
