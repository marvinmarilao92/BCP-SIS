...
<?php $page = 'C'; $col = 'list'; include ('core/sidebar.php');//Design for sidebar?>
                          ...
                          <div class="card-body" >           
                            ...
                            <table class="table table-hover datatable" >
                              ...
                              <?php
                                  ...
                                  $query="SELECT * FROM audit_logs WHERE `action_name` = 'hdms Cashier' ORDER BY login_time DESC ";
                        ...
                        <div class="card">
                          ...
                          <div class="card-body" >           
                            ...
                            <table class="table table-hover datatable" >
                              ...
                              <?php
                                    require_once("include/conn.php");
                                    $query="SELECT * FROM audit_trail WHERE `actor` = 'hdms Cashier' ORDER BY date DESC ";
                                    $result=mysqli_query($conn,$query);
                                    while($rs=mysqli_fetch_array($result)){
                                      $id = $rs['account_no']; 
                                      $host = $rs['host']; 
