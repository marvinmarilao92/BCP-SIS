...
<?php $page = 'P'; $col = 'managef';include ('core/sidebar.php');//Design for sidebar?>
                        ...
                        <div class="modal-header">
                          ...
                          <div class="card" style="margin: 10px;">
                            <div class="card-body">
                                ...
                                <div class="row g-3" >
                                  <div class="col-md-4">
                                      <!-- <input type="text" class="form-control" placeholder="faqs Code" id="dtcode" required> -->
                                  </div>
                                  <br>
                                  <div class="col-md-12">
                                  ...
                                  <br>
                                  <div class="col-12">
                                      <textarea class="form-control" style="height: 100px" placeholder="Answer/Instruction" id="longDesc" required></textarea>
                                  </div>        
                                </div>
                            ...
                            <div class="card-body">
                              <h2 class="card-title">Change information</h2>
                                ...
                                <div class="row g-3" >
                                  ...
                                  <div class="col-md-12">
                                  Question: <input type="text" class="form-control" id="titleE">
                                  </div>
                                  <br>
                                  <div class="col-md-12">
                ...
                $('#save').click(function(a){ 
                  a.preventDefault();
                    if($('#title').val()!="" && $('#shortDesc').val()!="" && $('#longDesc').val()!=""){
                      $.post("function/add_faqs_reg.php", {
                        title:$('#title').val(),
