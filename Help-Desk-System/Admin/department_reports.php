...
<!DOCTYPE html>
<html lang="en">
<title>Help Desk | Department Reports</title>
<head>
...
<?php $page = 'DR'; $col = 'reports';include ('core/sidebar.php');//Design for sidebar?>
            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTabjustified" role="tablist" style="margin-top: 10px;">
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100 active" id=" incoming-tab" data-bs-toggle="tab" data-bs-target="#IncomingDocs" type="button" role="tab" aria-controls="incoming" aria-selected="true">Cashier</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="received-tab" data-bs-toggle="tab" data-bs-target="#ReceivedDocs" type="button" role="tab" aria-controls="profile" aria-selected="false">Accounting</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="approved-tab" data-bs-toggle="tab" data-bs-target="#ApprovedDocs" type="button" role="tab" aria-controls="approved" aria-selected="false">Admission</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="registrar-tab" data-bs-toggle="tab" data-bs-target="#Registrar" type="button" role="tab" aria-controls="registrar" aria-selected="false">Registrar</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="staff-tab" data-bs-toggle="tab" data-bs-target="#Staff" type="button" role="tab" aria-controls="record" aria-selected="false">Staff</button>
                </li>
              </ul>
                              ...
                              <div class="card-body" >           
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <tbody>
                                    <?php
                                      require_once("include/conn.php");
                                      $query="SELECT * FROM hd_department WHERE shortDesc = 'Registrar' ORDER BY date DESC";
                                      $result=mysqli_query($conn,$query);
                                      while($rs=mysqli_fetch_array($result)){
                                        $id =$rs['id']; 
                                        $title = $rs['title']; 
