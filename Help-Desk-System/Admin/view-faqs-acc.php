...
<?php $page = 'D'; $col = 'managef';include ('core/sidebar.php');//Design for sidebar?>
                            ...
                            <div class="card-body">
                              <h2 class="card-title">Change information</h2>
                                ...
                                <div class="row g-3" >
                                  ...
                                  <br>
                                  <div class="col-md-12">
                                      Department: <input type="hidden" class="form-control" id="shortDescE">
                                  </div>
                                  <br>
                                  <div class="col-12">
                ...
                $('#save').click(function(a){ 
                  a.preventDefault();
                    if($('#title').val()!="" && $('#shortDesc').val()!="" && $('#longDesc').val()!=""){
                      $.post("function/add_faqs_acc.php", {
                        title:$('#title').val(),
