...
<!DOCTYPE html>
<html lang="en">
<title>Help Desk | Ticket Reports</title>
<head>
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      $query="SELECT * FROM hdms_tickets WHERE status=$new_status ORDER BY date DESC ";
                                    ...
                                    <tr>
                                      ...
                                      <td data-title = "Department ">
                                        <?php if($rs['ticket_department'] == "hdms Accounting"): ?>
                                          <span class="badge bg-primary">Accounting</span>
                                        <?php elseif($rs['ticket_department'] == "hdms Registrar"): ?>
                                          <span class="badge bg-warning text-dark">Registrar</span>
                                          <?php elseif($rs['ticket_department'] == "hdms Admission"): ?>
                                          <span class="badge bg-secondary">Admission</span>
                                          <?php elseif($rs['ticket_department'] == "hdms Cashier"): ?>
                                          <span class="badge bg-info">Cashier</span>
                                        <?php elseif($rs['ticket_department'] == "Staff"): ?>
                            ...
                            <div class="card">
                              ...
                              <div class="card-body" >           
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <?php
                                      require_once("include/conn.php");
                                      $query="SELECT * FROM hdms_tickets WHERE status=1 ORDER BY 'date' DESC";
                                      $result=mysqli_query($conn,$query);
                                      while($rs=mysqli_fetch_array($result)){
                                        $id =$rs['id']; 
                                        $student_number = $rs['student_number']; 
                              ...
                              <div class="card-body" >           
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <tbody>
                                    <?php
                                      require_once("include/conn.php");
                                      $query="SELECT * FROM hdms_tickets WHERE status=2 ORDER BY date DESC ";
                                      $result=mysqli_query($conn,$query);
                                      while($rs=mysqli_fetch_array($result)){
                                        $id =$rs['id']; 
                                        $student_number = $rs['student_number']; 
                              ...
                              <div class="card-body" >           
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <tbody>
                                    <?php
                                      require_once("include/conn.php");
                                      $query="SELECT * FROM hdms_tickets ORDER BY date DESC ";
                                      $result=mysqli_query($conn,$query);
                                      while($rs=mysqli_fetch_array($result)){
                                        $id =$rs['id']; 
                                        $student_number = $rs['student_number']; 
