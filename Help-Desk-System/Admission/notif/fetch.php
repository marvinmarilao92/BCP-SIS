...
if(isset($_POST["view"]))
{
 ...
 if($_POST["view"] != '')
 {
  $update_query = "UPDATE datms_notification SET stat1 = 1 WHERE (act1 = 'hdms Admission') AND stat1 = 0";
  mysqli_query($conn, $update_query);
 }
 $query = "SELECT * FROM datms_notification WHERE (act1 = 'hdms Admission') ORDER BY date desc LIMIT 10";
