...
<?php $page = 'task'; include ('core/sidebar.php');//Design for sidebar?>
                ...
                <table class="table table-hover datatable" id="categoryTable">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" WIDTH="50%">Answer/Instruction</th>         
                      <th style="display:none"></th>
                      <th >Date Created</th>
                        ...
                        <div class="modal-header">
                          ...
                          <div class="card" style="margin: 10px;">
                            <div class="card-body">
                                ...
                                <div class="row g-3" >
                                  <div class="col-md-4">
                                      <!-- <input type="text" class="form-control" placeholder="category Code" id="dtcode" required> -->
                                  </div>
                                  <br>
                                  <div class="col-md-12">
                      ...
                      <div class="card" style="margin: 10px;">
                            <div class="card-body">
                              <h5 class="card-title">Category Details</h5>
                               ...
                               Category: <h5 id="view_name" style="margin-left: 60px;"></h5>
                            ...
                            <div class="card-body">
                              <h2 class="card-title">Change information</h2>
                                ...
                                <div class="row g-3" >
                                  ...
                                  <div class="col-md-12">
                                  Category: <input type="text" class="form-control" id="titleE">
                                  </div>
                                  <br>
                                  <div class="col-md-12">
                                  Answer/Instruction: <textarea class="form-control" style="height: 100px" placeholder="Description" id="shortDescE" required></textarea>
                                  </div>
                                  <br>
                      ...
                      <div class="modal-header">
                        ...
                        <div class="card" style="margin: 10px;">
                          <div class="card-body">                
                            ...
                            <center>
                              <h5 class="text-danger">Are you sure you want to delete this Category?</h5>
    ...
    <script> 
        ...
        $(document).ready(function () {
              ...
              $("#dtdel").click(function(b){
                b.preventDefault();
                $.post("function/delete_cat.php",{
                    dtid:$('#delete_id').val()
                  },function(response){
                    // alert ("deleted");
                    if(response.trim() == "Category Deleted"){
                      $('#DeleteModal').modal('hide');
                      Swal.fire ("Category Successfully Deleted","","success").then(function(){
                    ...
                    if($('#title').val()!="" && $('#shortDesc').val()!=""){
                      $.post("function/add_cat.php", {
                        ...
                        if (data.trim() == "failed"){
                          $('#AddModal').modal('hide');
                          //response message
                          Swal.fire("category already in exist","","error");
                      ...
                      if($('#idE').val()!="" && $('#titleE').val()!="" && $('#shortDescE').val()!=""){
                        $.post("function/update_cat.php", {
                          ...
                          shortDesc:$('#shortDescE').val(),
                            ...
                            Swal.fire("category Title is currently in use","","error");//response message
                            // Empty test field
                            $('#titleE').val("")
                            $('#shortDescE').val("")
