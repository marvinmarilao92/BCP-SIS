                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      $query="SELECT * FROM hdms_tickets WHERE status=$new_status AND ticket_department = 'hdms Accounting' ORDER BY date DESC ";
                            ...
                            <div class="card">
                              ...
                              <div class="card-body" >           
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <?php
                                      require_once("include/conn.php");
                                      $query="SELECT * FROM hdms_tickets WHERE status=1 AND ticket_department = 'hdms Accounting' ORDER BY 'date' DESC";
                                      $result=mysqli_query($conn,$query);
                                      while($rs=mysqli_fetch_array($result)){
                                        $id =$rs['id']; 
                                        $student_number = $rs['student_number']; 
                              ...
                              <div class="card-body" >           
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <tbody>
                                    <?php
                                      require_once("include/conn.php");
                                      $query="SELECT * FROM hdms_tickets WHERE status=2 AND ticket_department = 'hdms Accounting' ORDER BY date DESC ";
                                      $result=mysqli_query($conn,$query);
                                      while($rs=mysqli_fetch_array($result)){
                                        $id =$rs['id']; 
                                        $student_number = $rs['student_number']; 
                              ...
                              <div class="card-body" >           
                                ...
                                <table class="table table-hover datatable" >
                                  ...
                                  <tbody>
                                    <?php
                                      require_once("include/conn.php");
                                      $query="SELECT * FROM hdms_tickets WHERE ticket_department = 'hdms Accounting' ORDER BY date DESC ";
                                      $result=mysqli_query($conn,$query);
                                      while($rs=mysqli_fetch_array($result)){
                                        $id =$rs['id']; 
                                        $student_number = $rs['student_number']; 
