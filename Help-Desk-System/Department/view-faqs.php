              ...
              <table class="table table-hover datatable" id="DocTypeTable">
                ...
                <tbody>
                  <?php
                    ...
                    $query="SELECT * FROM hd_department ORDER BY date DESC";
                            ...
                            <div class="card-body">
                              <h2 class="card-title">Fill all neccessary info</h2>
                                ...
                                <div class="row g-3" >
                                  ...
                                  <div class="col-md-12">
                                      <input type="text" class="form-control" placeholder="Department" id="shortDesc" required>
                                  </div>
                                  <br>
                                  <div class="col-12">
                                      <textarea class="form-control" style="height: 80px" placeholder="Description" id="longDesc" required></textarea>
                                  </div>        
                                </div>
                            ...
                            <div class="card-body">
                              <h2 class="card-title">Change information</h2>
                                ...
                                <div class="row g-3" >
                                  ...
                                  <br>
                                  <div class="col-md-12">
                                      Department: <input type="text" class="form-control" id="shortDescE">
                                  </div>
                                  <br>
                                  <div class="col-12">
                                      Description: <textarea  style="height: 80px" class="form-control" id="longDescE"></textarea>
                                  </div>        
                                </div>
