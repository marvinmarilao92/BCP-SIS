    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="row g-3">
          <div class="col-md-2">
            <input type="number" name="student_number" class="form-control <?php echo (!empty($student_number_err)) ? 'is-invalid' : ''; ?>" Required placeholder="Student Number">
          ...
          <div class="col-md-3">
            <select id="inputState" name="year_level" class="form-select" Required>
              <option value="" selected="selected" disabled="disabled">Select Year Level</option>
          ...
          <div class="col-md-3">
            <select id="inputState" name="school_year" class="form-select" Required>
