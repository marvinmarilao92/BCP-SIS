                    ...
                    ";
                      ...
                      if($mail->send()){
                            ...
                            if($update_notif){
                              ...
                              VALUES ('$verified_session_firstname $verified_session_lastname', '0' ,'','0','Request Approved','You approved request for $R_docu','$verified_session_office','Active','$date','$R_code')") or die(mysqli_error($conn));
                      
                              //notif of students              
                              $conn->query("INSERT INTO datms_notification (act1, stat1, act2, stat2, subject, notif, dept, status, date, affected)
                              VALUES ('', '0' ,'$R_studid','0','Request Approved','Your $R_docu is Approved by $verified_session_firstname $verified_session_lastname','$verified_session_office','Active','$date','$R_code')") or die(mysqli_error($conn));                               
