...
<?php $page = 'ROL' ; $col = 'logs'; include ('core/side-nav.php');//Design for sidebar?>

<main id="main" class="main">

<div class="pagetitle">
  <h1>Registrar Officer Logs</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="index.html">Home</a></li>
      <li class="breadcrumb-item">Module</li>
      <li class="breadcrumb-item">Audit Trail</li>
      <li class="breadcrumb-item active">Registrar Officer Logs</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
