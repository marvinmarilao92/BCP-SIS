                ...
                <canvas id="barChart" style="max-height: 470px;"></canvas>
                 <?php
                       require_once("include/conn.php");
                             ...
                             $sql ="SELECT *,count(doc_off3) as countoff FROM datms_documents group by doc_off3;";
            ...
            <div class="col-12">
              <div class="card">
                ...
                <canvas id="lineChart" style="max-height: 470px;"></canvas>
                 <?php
                       require_once("include/conn.php");
                            $sql2="SELECT *, YEAR(`stud_date`) AS Stud_Year, count('Stud_Year') as countyear FROM student_information group by Stud_Year";
                            //  $sql ="SELECT *,count(doc_off3) as count FROM datms_documents group by doc_off3;";
                             $result2 = mysqli_query($conn,$sql2);
                             $chart_data="";
                             while ($row = mysqli_fetch_array($result2)) { 
                                $name2[]  = $row['Stud_Year']  ;
                                $counts2[] = $row['countyear'];
                            }
