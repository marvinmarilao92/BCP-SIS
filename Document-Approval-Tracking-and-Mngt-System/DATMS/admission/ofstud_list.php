...
<?php $page = 'offlist' ; $col = 'reports'; include ('core/side-nav.php');//Design for sidebar?>
              ...
              <table class="row-border hover datatable table" id="DocTypeTable">
                ...
                <tbody>
                  <?php
                    ...
                    $query="SELECT * FROM student_information WHERE account_status = 'Offical' ORDER BY stud_date DESC ";
                    $result=mysqli_query($conn,$query);
                    while($rs=mysqli_fetch_array($result)){
                      $adm_no =$rs['id_number'];
                      $adm_fname = $rs['firstname'];
                      $adm_lname = $rs['lastname'];        
                      $adm_mname = $rs['middlename'];
