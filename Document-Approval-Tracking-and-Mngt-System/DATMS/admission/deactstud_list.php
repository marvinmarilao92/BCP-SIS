...
<!Students html>
<html lang="en">
<title>ADMISSION | Deactivated Enrolled</title>
<head>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Deactivated List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <table class="row-border hover datatable table" id="StudentsTable">
                ...
                <tbody>
                  <?php
                    ...
                    $query="SELECT *,LEFT(middlename,1) FROM student_information WHERE account_status = 'Deactivated' ORDER BY id DESC ";
