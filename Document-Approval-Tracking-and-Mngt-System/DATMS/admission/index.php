    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if($count == 0 && $count2 == 0) {
        ...
        if($stmt = mysqli_prepare($link, $sql)){
          ...
          mysqli_stmt_bind_param($stmt, "issssssssssssssss", $student_number, $first_name, $last_name, $middle_name, $email, $contact, $address, $course, $year_level, $section, $school_year, $gender, $birthday, $nationality, $religion, $civil_status, $account_status);
          ...
          if(mysqli_stmt_execute($stmt)){
            ...
            if($stmt1 = mysqli_prepare($link, $sql)){
              ...
              if(mysqli_stmt_execute($stmt1)){
                  ...
                  $query = "DELETE FROM student_application WHERE id_number='$code'";
