...
<!Students html>
<html lang="en">
<title>ADMISSION | Returnee Enrolled</title>
<head>
...
<?php $page = 'retlist' ; $col = 'reports'; include ('core/side-nav.php');//Design for sidebar?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Returnee Enrolled List</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Settings</li>
          <li class="breadcrumb-item active">Returnee Enrolled List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <table class="row-border hover datatable table" id="StudentsTable">
                ...
                <tbody>
                  <?php
                    ...
                    $query="SELECT *,LEFT(middlename,1) FROM student_information WHERE account_status = 'Returnee' ORDER BY id DESC ";
