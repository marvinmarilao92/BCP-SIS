...
if(isset($_POST["view"]))
{
 ...
 if($_POST["view"] != '')
 {
  $update_query = "UPDATE datms_notification SET stat1 = 1 WHERE (act1 = '$verified_session_firstname $verified_session_lastname' OR act1 = 'Registrar Department') AND dept = '$verified_session_office' AND stat1 = 0";
  mysqli_query($conn, $update_query);
 }
 $query = "SELECT * FROM datms_notification WHERE (act1 = '$verified_session_firstname $verified_session_lastname' OR act1 = 'Registrar Department') AND dept = '$verified_session_office' ORDER BY date desc LIMIT 10";
 ...
 $query_1 = "SELECT * FROM datms_notification WHERE (act1 = '$verified_session_firstname $verified_session_lastname' OR act1 = 'Registrar Department') AND dept = '$verified_session_office' AND stat1 = 0";
