        ...
        <div class="modal-body">        
            <div class="card-body">        
              <?php
                ...
                $query="SELECT * FROM datms_notification WHERE act1 = '$verified_session_firstname $verified_session_lastname' AND dept = '$verified_session_office' ORDER BY date DESC";
