    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
          <li class="dropdown-header">
            ...
            <a data-bs-toggle="modal" data-bs-target="#modalDialogScrollable"><span
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          ...
          <span
            class="d-none d-md-block dropdown-toggle ps-2"><?php echo $verified_session_firstname . " " . $verified_session_lastname ?></span>
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center"
              href="logs_personal?id=<?php echo $_SESSION["login_key"]; ?>">
      ...
      <div class="modal-body">
        <div class="card-body">
          ...
          <div class="card" style="padding:20px">
            <h6 style="font-weight: bold;"><a href="<?php echo $links; ?>"
                style="color: black;"><?php echo $rs["subject"]; ?></a></h6>
