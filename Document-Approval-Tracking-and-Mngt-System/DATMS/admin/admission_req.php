...
<!Students html>
  ...
  <body>
    ...
    ?>
    <?php $page = 'req';
    include('core/side-nav.php'); //Design for sidebar
    ?>
    ...
    <main id="main" class="main">
      ...
      <div class="alert alert-secondary alert-dismissible fade show" role="alert">
        ...
        <p>
          You may use the service and the contents contained in the Services solely for your own individual
          non-commercial and informational purpose
          only. Any other use, including for any commercial purposes, is strictly prohibited without our express prior
          witten or verbal consent.
        </p>
        <hr>
                ...
                <div class="card-body">
                  ...
                  <table class="row-border hover datatable table" id="AdmTable">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td data-label="Student No."><a data-bs-toggle="modal"
                            data-bs-target="#ViewModal<?php echo $adm_id; ?>"><?php echo $adm_no; ?></a></td>
                        <td data-label="Name" WIDTH="25%">
                          <?php echo $adm_fname . ' ' . $adm_mname . '.' . ' ' . $adm_lname; ?></td>
        ...
        <div class="modal-content">
          ...
          <div class="card" style="margin: 10px;">
            <div class="card-body">
              ...
              <h6 id="req_receiver" style="color:black">
                <?php echo "Receiver: " . $verified_session_firstname . " " . $verified_session_lastname; ?></h6>
    ...
    <a href="#" class="back-to-top d-flex align-items-center justify-content-center"
      style="background-color: rgb(13, 110, 253);"><i class="bi bi-arrow-up-short"></i></a>
