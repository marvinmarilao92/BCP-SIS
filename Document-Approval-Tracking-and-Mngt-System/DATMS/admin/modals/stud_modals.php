                    ...
                    <div class="modal-content">
                      ...
                      <div class="card" >
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                  ...
                                  <div class="row">
                                    <h6>Year Level&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $rs['year_level'];?></h6>
                                  </div>
                                  
                                   <div class="row">
                                    <h6>School Year&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $rs['school_year'];?></h6>
                                  </div>
                                  
                                   <div class="row">
                                    <h6>Section&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $rs['section'];?></h6>
                                  </div>

                                  <div class="row">
                                    <h6>Date Enrolled&nbsp;&nbsp;&nbsp;:<?php echo $rs['stud_date'];?></h6>
                                  </div>
                                </div> 
                            </div>
                          </div>   
