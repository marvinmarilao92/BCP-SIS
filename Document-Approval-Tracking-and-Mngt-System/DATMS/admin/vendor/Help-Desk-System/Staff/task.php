...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-12 col-md-12" >
            ...
            <div class="card mb-3" style = "top: 22px">
                <div class="card-body" >
                    <div class="list-inline admn_ul">
                    <button class="btn btn-warning btn-menu" data-bs-toggle="modal" data-bs-target="#disablebackdrop">Assign Task</button>
...
<?php include ('task_info.php');//connection?>
<!-- End Footer -->
