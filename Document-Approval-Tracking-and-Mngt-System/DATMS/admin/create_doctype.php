                        ...
                        <div class="card" style="margin: 10px;">
                          <div class="card-body">
                            <h2 class="card-title">Change information</h2>
                              <!-- Fill out Form -->
                              <div class="row g-3" >
                                <input type="hidden" class="form-control" id="off_idE">
                                <div class="col-md-4">
                                    Code: <input type="text" class="form-control" id="off_codeE">
                                </div>
                                <br>
                                <div class="col-md-8">
          ...
          // Opening modal for delete
            ...
            // Edit Office modal calling
              $('.editbtn').on('click', function () {
                  ...
                  console.log(data);        
                      document.getElementById("off_id").placeholder = data[0];
                      document.getElementById("off_code").placeholder = data[1];
                      document.getElementById("off_name").placeholder = data[2];
                      document.getElementById("off_loc").placeholder = data[3];  
              });
            ...
            $('#edit').click(function(a){ 
                  a.preventDefault();
                    if($('#offcodeE').val()!="" && $('#offtitleE').val()!="" && $('#offlocE').val()!=""){
                      $.post("add_office.php", {
                        offcode:$('#offcode').val(),
                        offname:$('#offtitle').val(),
                        offloc:$('#offloc').val()
